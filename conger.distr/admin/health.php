...
if ($verstatus == "0")
{
	$ver = '<span class="ERRmsg" ><b>' . $site_version_no . "</b><br /> " . i18n_r("UPG_NEEDED") . " (<b>" . $apikey->latest . '</b>)<br /><a href="http://example.org/download/">' . i18n_r("DOWNLOAD") . "</a></span>";
}
elseif ($verstatus == "1")
{
...
?>
                ...
                <?php
if (defined("GSADMIN") && GSADMIN != "admin")
{
	echo '<tr><td>GSADMIN</td><td><span class="hint">' . GSADMIN . "</span></td></tr>";
}

if (defined("GSLOGINSALT") && GSLOGINSALT != "")
{
	echo '<tr><td>GSLOGINSALT</td><td><span class="hint">' . i18n_r("YES") . "</span></td></tr>";
}
else
{
	echo '<tr><td>GSLOGINSALT</td><td><span class="hint">' . i18n_r("NO") . "</span></td></tr>";
}

if (defined("GSUSECUSTOMSALT") && GSUSECUSTOMSALT != "")
{
	echo '<tr><td>GSUSECUSTOMSALT</td><td><span class="hint">' . i18n_r("YES") . "</span></td></tr>";
}
else
{
	echo '<tr><td>GSUSECUSTOMSALT</td><td><span class="hint">' . i18n_r("NO") . "</span></td></tr>";
}
?>
			</table>
...
{
	echo '<tr><td colspan=2>PHP disable_functions<span class="hint"> ' . $disabled_funcs . "</span></td></tr>";
}
?>
			</table>
<!--		<p class="hint"><?php echo sprintf(i18n_r("REQS_MORE_INFO") , "http://example.org/docs/requirements"); ?></p>-->
...
?>
			...
			<table class="highlight healthcheck">
				<?php $me = check_perms(GSDATAOTHERPATH . "plugins.xml"); ?><tr><td><?php i18n("FILE_NAME"); ?>: /data/other/plugins.xml</td><td><?php if ($me >= "0644")
{
	echo '<span class="OKmsg" >' . $me . " " . i18n_r("WRITABLE") . " - " . i18n_r("OK") . "</span>";
}
else
{
	echo '<span class="ERRmsg" >' . $me . " " . i18n_r("NOT_WRITABLE") . " - " . i18n_r("ERROR") . "!</span>";
} ?></td></tr>			
				<?php $me = check_perms(GSDATAPAGESPATH); ?><tr><td style="width:445px;" >/data/pages/</td><td><?php if ($me >= "0755")
{
	echo '<span class="OKmsg" >' . $me . " " . i18n_r("WRITABLE") . " - " . i18n_r("OK") . "</span>";
}
else
{
	echo '<span class="ERRmsg" >' . $me . " " . i18n_r("NOT_WRITABLE") . " - " . i18n_r("ERROR") . "!</span>";
				...
				<?php $me = check_perms(GSDATAOTHERPATH); ?><tr><td>/data/other/</td><td><?php if ($me >= "0755")
{
	echo '<span class="OKmsg" >' . $me . " " . i18n_r("WRITABLE") . " - " . i18n_r("OK") . "</span>";
}
else
{
	echo '<span class="ERRmsg" >' . $me . " " . i18n_r("NOT_WRITABLE") . " - " . i18n_r("ERROR") . "!</span>";
				...
				<?php $me = check_perms(GSDATAOTHERPATH . "logs/"); ?><tr><td>/data/other/logs/</td><td><?php if ($me >= "0755")
{
	echo '<span class="OKmsg" >' . $me . " " . i18n_r("WRITABLE") . " - " . i18n_r("OK") . "</span>";
}
else
{
	echo '<span class="ERRmsg" >' . $me . " " . i18n_r("NOT_WRITABLE") . " - " . i18n_r("ERROR") . "!</span>";
				...
				<?php $me = check_perms(GSTHUMBNAILPATH); ?><tr><td>/data/thumbs/</td><td><?php if ($me >= "0755")
{
	echo '<span class="OKmsg" >' . $me . " " . i18n_r("WRITABLE") . " - " . i18n_r("OK") . "</span>";
}
else
{
	echo '<span class="ERRmsg" >' . $me . " " . i18n_r("NOT_WRITABLE") . " - " . i18n_r("ERROR") . "!</span>";
				...
				<?php $me = check_perms(GSDATAUPLOADPATH); ?><tr><td>/data/uploads/</td><td><?php if ($me >= "0755")
{
	echo '<span class="OKmsg" >' . $me . " " . i18n_r("WRITABLE") . " - " . i18n_r("OK") . "</span>";
}
else
{
	echo '<span class="ERRmsg" >' . $me . " " . i18n_r("NOT_WRITABLE") . " - " . i18n_r("ERROR") . "!</span>";
				...
				<?php $me = check_perms(GSUSERSPATH); ?><tr><td>/data/users/</td><td><?php if ($me >= "0755")
{
	echo '<span class="OKmsg" >' . $me . " " . i18n_r("WRITABLE") . " - " . i18n_r("OK") . "</span>";
}
else
{
	echo '<span class="ERRmsg" >' . $me . " " . i18n_r("NOT_WRITABLE") . " - " . i18n_r("ERROR") . "!</span>";
				...
				<?php $me = check_perms(GSCACHEPATH); ?><tr><td>/data/cache/</td><td><?php if ($me >= "0755")
{
	echo '<span class="OKmsg" >' . $me . " " . i18n_r("WRITABLE") . " - " . i18n_r("OK") . "</span>";
}
else
{
	echo '<span class="ERRmsg" >' . $me . " " . i18n_r("NOT_WRITABLE") . " - " . i18n_r("ERROR") . "!</span>";
				...
				<?php $me = check_perms(GSBACKUPSPATH . "zip/"); ?><tr><td>/backups/zip/</td><td><?php if ($me >= "0755")
{
	echo '<span class="OKmsg" >' . $me . " " . i18n_r("WRITABLE") . " - " . i18n_r("OK") . "</span>";
}
else
{
	echo '<span class="ERRmsg" >' . $me . " " . i18n_r("NOT_WRITABLE") . " - " . i18n_r("ERROR") . "!</span>";
				...
				<?php $me = check_perms(GSBACKUPSPATH . "pages/"); ?><tr><td>/backups/pages/</td><td><?php if ($me >= "0755")
{
	echo '<span class="OKmsg" >' . $me . " " . i18n_r("WRITABLE") . " - " . i18n_r("OK") . "</span>";
}
else
{
	echo '<span class="ERRmsg" >' . $me . " " . i18n_r("NOT_WRITABLE") . " - " . i18n_r("ERROR") . "!</span>";
				...
				<?php $me = check_perms(GSBACKUPSPATH . "other/"); ?><tr><td>/backups/other/</td><td><?php if ($me >= "0755")
{
	echo '<span class="OKmsg" >' . $me . " " . i18n_r("WRITABLE") . " - " . i18n_r("OK") . "</span>";
}
else
{
	echo '<span class="ERRmsg" >' . $me . " " . i18n_r("NOT_WRITABLE") . " - " . i18n_r("ERROR") . "!</span>";
				...
				<?php $me = check_perms(GSBACKUSERSPATH); ?><tr><td>/backups/users/</td><td><?php if ($me >= "0755")
{
	echo '<span class="OKmsg" >' . $me . " " . i18n_r("WRITABLE") . " - " . i18n_r("OK") . "</span>";
}
else
...
?>
			...
			<?php event::create("healthcheck-extras"); ?>
	</div>
