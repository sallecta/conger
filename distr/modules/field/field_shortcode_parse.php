...
function parse( &$a_content )
{
	...
	//dev::ehtmlcom(['parsed',mb_substr($a_content, 0, 15).'...','replaced_fields',$replaced_fields]);
	//dev::ehtmlcom(['$a_content',$a_content]);
	if ( count($replaced_fields) > 0 )
	{
		return true;
	}
	else
